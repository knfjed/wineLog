...
| やりたいこと                 | 細分化したタスク                                   | 7/20(月) | 7/21(火) | 7/22(水) | 7/23(木) |
| ---------------------------- | -------------------------------------------------- | -------- | -------- | -------- | -------- |
| データをフェッチして利用する | チュートリアルで勉強（データフェッチ、API ルート） | ○        | ○        | ○        |          |
| 　　　　　　　〃             | ワイン詳細ページにそれぞれ上がっているか確認       | ○        |          |          | ○        |
| 　　　　　　　〃             | ワイン一覧画面（stock）でデータ一覧表示させる      |          |          |          | ○        |
...
- ストックページ
  データを３つ取れるよう修正
  リンクをクリックすると、詳細ページに飛ぶようにする →<Link> id
